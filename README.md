...
|Scalability Considerations| Refer to the [Scalability](https://github.com/CAAPIM/APIM-Gateway-Developer-Tools/wiki/Ephemeral-Gateway-Reference-Architecture#scalability) section of the reference architecture. 
